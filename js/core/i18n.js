...
const IT = {
  ...
  'fav.userSave': 'Permetti di salvare i video trovati con «Chiedi»',
  'fav.userMax': 'Quanti al massimo',
  'fav.userNote': 'I video tenuti da parte compaiono qui sopra con l\'etichetta «salvato», così si distinguono da quelli inseriti da chi assiste — che possono comunque essere rimossi da qui.',
  ...
  'pt.keyboard': 'Tastiera', 'pt.phrases': 'Frasi',
  'pt.texts': 'I miei testi', 'pt.media': 'Media', 'pt.arm': 'Braccio',
  ...
  'btn.calibstop': 'Annulla calibrazione',
  ...
  'btn.start': 'Avvia', 'btn.soloparla': 'Ferma fuori da qui: SÌ', 'btn.soloparlaNo': 'Ferma fuori da qui: NO',
  'btn.pause': 'Pausa', 'btn.select': 'Seleziona',
  'btn.reread': 'Rileggi', 'btn.telegram': 'Telegram',
  'btn.mail': 'Manda',
  'btn.ask': 'Chiedi',
  ...
  'btn.diagUndo': 'Ripristina i precedenti', 'diag.log': 'Registro in console',
  'diag.always': 'Misura sempre',
  ...
  'sec.radio': 'Radio online', 'sec.telegram': 'Messaggi su Telegram',
  'sec.assistente': 'Assistente (domande e risposte)',
  'sec.email': 'Invio di messaggi email',
...
const EN = {
  ...
  'fav.userSave': 'Allow saving videos found with «Ask»',
  'fav.userMax': 'How many at most',
  'fav.userNote': 'Saved videos appear above marked «salvato».',
  ...
  'pt.keyboard': 'Keyboard', 'pt.phrases': 'Phrases',
  'pt.texts': 'My texts', 'pt.media': 'Media', 'pt.arm': 'Arm',
  ...
  'btn.calibstop': 'Cancel calibration',
  ...
  'btn.start': 'Start', 'btn.soloparla': 'Pause outside: YES', 'btn.soloparlaNo': 'Pause outside: NO',
  'btn.pause': 'Pause', 'btn.select': 'Select',
  'btn.reread': 'Read again', 'btn.telegram': 'Telegram',
  'btn.mail': 'Send',
  'btn.ask': 'Ask',
  ...
  'btn.diagUndo': 'Restore the previous ones', 'diag.log': 'Console log',
  'diag.always': 'Always measure',
  ...
  'sec.radio': 'Online radio', 'sec.telegram': 'Telegram messages',
  'sec.assistente': 'Assistant (questions and answers)',
  'sec.email': 'Sending email messages',
